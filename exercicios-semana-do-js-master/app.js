...
function isOdd(value){
  //esta função retorna verdadeiro se o valor passado for nr impar
  return value % 2 != 0 
  // return value %2 ===1 é a mesma coisa
}

const oddnumbers = randomNumbers.filter(isOdd)
//console.log(`This are odd numbers ${oddnumbers} of array ${randomNumbers}`)
//document.body.innerHTML = `This are odd numbers ${oddnumbers} of array ${randomNumbers}<br>`
...
const numberslessthan501 = crazyNumbers.reduce((accululator, crazyNumber) => 
    crazyNumber < 501 ? accululator+1 : accululator ,0)
...
const numbers = [5, 7, 3]
const exponumbers = numbers.map(number => number ** 2)
//console.log(`This is result of **2 >${exponumbers} of array ${numbers}`)
...
//const oldfilm = tarantinoMovies.filter(item => item.release < 2000)
const oldfilm = tarantinoMovies.filter(({release}) => release < 2000)
//console.log(oldfilm)
...
//const productList = cart.reduce((accumulator, product ) => { return `${accumulator}- ${product.name}\n`},'')
